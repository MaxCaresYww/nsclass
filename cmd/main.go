...
import (
	...
	"github.com/maxcaresyww/nsclass/internal/controller"
...
func init() {
	...
	utilruntime.Must(akuityiov1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(restConfig, ctrl.Options{
		...
		LeaderElectionID:       "d0d9f915.akuity.io",
	...
	if err := (&controller.NamespaceReconciler{
		...
		Recorder:  mgr.GetEventRecorder("namespace-controller"),
